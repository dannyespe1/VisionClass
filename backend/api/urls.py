...
router.register(r'd2r-sessions', views.D2RSessionViewSet, basename='d2r-session')
router.register(r'd2r-attention-events', views.D2RAttentionEventViewSet, basename='d2r-attention-event')
