      ...
      <section className="pt-28 pb-14 px-4 lg:px-2">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-semibold mt-2">
            Controles y proteccion empresarial
          </h1>
          <p className="text-slate-600 mt-4 text-lg">
            Nuestra infraestructura prioriza la confidencialidad, integridad y disponibilidad de la
            informacion academica, alineada a buenas practicas de seguridad.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-8">
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-8 space-y-4">
            ...
            <ul className="space-y-2 text-sm text-slate-600 list-disc list-inside">
              ...
              <li>Autenticacion JWT y control de acceso por roles.</li>
              <li>Registro de actividad y trazabilidad de acciones.</li>
              <li>Proteccion de endpoints criticos y validacion de datos.</li>
            </ul>
          </div>
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-8 space-y-4">
            <h2 className="text-2xl font-semibold">Operacion segura</h2>
            <ul className="space-y-2 text-sm text-slate-600 list-disc list-inside">
              <li>Retencion limitada de datos y borrado seguro.</li>
              <li>Backups controlados y restauracion planificada.</li>
              <li>Monitoreo de disponibilidad y alertas preventivas.</li>
              <li>Separacion de entornos y configuracion por permisos.</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 lg:px-2 pb-20">
        <div className="max-w-5xl mx-auto bg-slate-900 text-white rounded-3xl p-10 space-y-4">
          ...
          <p className="text-sm text-slate-200">
            Actualizamos controles y politicas para mantener el cumplimiento normativo y
            reducir riesgos operativos. Recomendamos mantener credenciales seguras y
            revisar los permisos periodicamente.
          </p>
        </div>
      </section>
