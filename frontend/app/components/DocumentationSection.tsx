  ...
  return (
    <section id="documentacion" className="max-w-6xl mx-auto px-4 lg:px-2 py-16">
      <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-6 sm:p-8 md:p-10 space-y-4">
        ...
        <h2 className="text-3xl font-semibold text-slate-900">Repositorio y guías técnicas</h2>
        <p className="text-slate-600">
          Consulta la documentación técnica, arquitectura y guía de despliegue en el repositorio oficial.
        </p>
        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
          ...
          <p className="text-sm text-slate-500">
            Incluye configuración de servicios, API y flujos principales.
          </p>
        </div>
      </div>
    </section>
