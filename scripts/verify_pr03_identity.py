...
require("backend/api/models.py", ("SecurityAuditEvent", "uniq_attention_event_idempotency", "uniq_d2r_event_idempotency"))
...
for class_name in ("AttentionEventSerializer", "D2RAttentionEventSerializer", "ContentViewSerializer", "QuizAttemptSerializer"):
